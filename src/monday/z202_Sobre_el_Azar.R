...
## - ¿Tiene realmente alguna ventaja la partición estratificada ?
...
print(paste0("Ganancia Minima: ", min(resultados_n_gan)))

# La mayor ganancia
print(paste0("Ganancia Max: ", max(resultados_n_gan)))

# La media de la ganancia
print(paste0("Ganancia Media: ", mean(resultados_n_gan)))

# Coef. variacion
print(paste0("Coef. variacion: ", sd(resultados_n_gan) / mean(resultados_n_gan)))
...
# La CV de la ganancia
print(sd(resultados_n_mcv) / mean(resultados_n_mcv))
...
print(sd(resultados_mis_semillas))
